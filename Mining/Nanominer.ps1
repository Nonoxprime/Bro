...
if (-not (Test-Path ".\Soft\Nanominer-1.2.4")) {
    ...
    Invoke-WebRequest -Uri "https://gameoverblog.fr/Scripting/nanominer-windows-1.2.4.zip" -OutFile ".\Download\nanominer-windows-1.2.4.zip"
    ...
    New-Item -Path ".\Soft\" -Name "Nanominer-1.2.4" -ItemType directory -force
    Invoke-WebRequest -Uri "https://gameoverblog.fr/Scripting/nanominer-windows-1.2.4zip" -OutFile ".\Download\nanominer-windows-1.2.4.zip"
    expand-archive -path '.\Download\nanominer-windows-1.2.4.zip' -destinationpath '.\Soft\Nanominer-1.2.4' -force
